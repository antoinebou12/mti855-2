...
Spherical::Spherical(RigidBody* _body0, RigidBody* _body1, const Eigen::Vector3f& _r0, const Eigen::Vector3f& _r1) : Joint(_body0, _body1, _r0, Eigen::Quaternionf::Identity(), _r1, Eigen::Quaternionf::Identity(), kSpherical)
{
    dim = 3;
    J0.setZero(3, 6);
    J1.setZero(3, 6);
...
void Spherical::computeJacobian()
{
    ...
    // which is simply the displacement between the two attachment points.
    //
    ...
    // Compute the cached JM^-1 blocks used by the solver.
    //
